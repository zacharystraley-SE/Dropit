...
| **Video** | MP4, QuickTime, Matroska, WebM, AVI, M4V |
...
- [ ] **More formats.** Additional file extension support is coming. Still working out how to package those libraries so the download isn't 1.5+ GB.
...
Dropit is in active development for macOS 14 and later, on both Apple silicon and Intel Macs. The source is proprietary and maintained in a private repository.

Screenshots and a signed, notarized DMG will be posted here once the first release is ready.
